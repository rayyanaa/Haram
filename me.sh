...
apt install git
pkg install python python2 python3 vim figlet curl
clear
echo
echo
echo
...
echo
echo $pur"#################" $pu "##################"
echo $pur"#"      $pu" Welcome To TOOLS me " $pur" #"
echo $pur"#################" $pu "##################"
echo
sleep 1
echo $pur"=============≠====" $cy "======================"
